...
def connecting_subtour_horizontal(cities_coords, stour1, stour2, last_col, first_row, height):
    ...
    def line_intersection(line1, line2):
        y_range = [line1[0][1],line1[1][1],line2[0][1],line2[1][1]]
        min_y = min(y_range)
        max_y = max(y_range)
    ...
    def swapping(arc1, arc2):
        #across is True if they intersect
        across = line_intersection((arc1[0],arc2[0]),(arc1[1],arc2[1]))
        if across is False:
...
def connecting_subtour_vertical(cities_coords, stour1, stour2, new_arcs, last_row, first_col, width):
    ...
    # ex: (15, 22), (18, 25)), ((13, 29), (6, 28)
    def line_intersection(line1, line2):
        x_range = [line1[0][0], line1[1][0], line2[0][0], line2[1][0]]
        min_x = min(x_range)
        max_x = max(x_range)
        xdiff = (line1[0][0] - line1[1][0], line2[0][0] - line2[1][0])
        ydiff = (line1[0][1] - line1[1][1], line2[0][1] - line2[1][1])
